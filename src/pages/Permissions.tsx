export function PermissionsPage() {
  return (
    <div className="legal-page">
      ...
      <PermSection icon="👥" title="Contacts"
      ...
      />
      <PermSection icon="🖼️" title="Media (Photos, Videos & Files)"
      ...
      />
      <PermSection icon="🔔" title="Notifications"
      ...
      />
      <PermSection icon="🎙️" title="Microphone"
...
function PermSection({ icon, title, why, how, manage }: { icon: string; title: string; why: string; how: string; manage: string }) {
  return (
